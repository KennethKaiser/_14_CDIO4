...
class TC8_PropertyTest {
    ...
    void testBuyingRødovrevej() {
       ...
       GameActions.buyProperty(player,fieldPropertyAction.getProperty());
        ...
        assertEquals(fieldPropertyAction.getOwner(),player,"Spilleren: " + player + " skulle gerne være ejer. Ejeren er: " + fieldPropertyAction.getOwner());
    }
    ...
    void testBuildingFailHouseRødovrevej() {
        ...
        FieldProperty fieldPropertyAction = (FieldProperty)board.getField(1);
        gameActions.buyProperty(player, fieldPropertyAction.getProperty());
        gameActions.buildHouse(player,fieldPropertyAction.getProperty());


        //Ser om player har rette mængde penge og Rødovrevej ikke har fået hus
        assertEquals(player.getMoney(),moneyAfterBuying,"Spilleren burde have: " + moneyAfterBuying + ". Spilleren har: "+ player.getMoney());
        assertEquals(fieldPropertyAction.getProperty().getBuildings(),0,"Rødovre skulle have bygninger: " + 0 + " Rødovre har: " + fieldPropertyAction.getProperty().getBuildings());
    }
    ...
    void testBuilding1HouseRødovrevej() {
        ...
        FieldProperty fieldPropertyAction = (FieldProperty)board.getField(1);
        FieldProperty fieldPropertyAction2 = (FieldProperty)board.getField(3);
        gameActions.buyProperty(player, fieldPropertyAction.getProperty());
        gameActions.buyProperty(player,fieldPropertyAction2.getProperty());
        gameActions.buildHouse(player, fieldPropertyAction.getProperty());


        //Ser om player har mistet rette mængde penge og Rødovrevej har fået en bygning
        assertEquals(player.getMoney(),moneyAfterBuying,"Spilleren burde have: " + moneyAfterBuying + ". Spilleren har: "+ player.getMoney());
        assertEquals(fieldPropertyAction.getProperty().getBuildings(),1,"Rødovre skulle have bygninger: " + 1 + " Rødovre har: " + fieldPropertyAction.getProperty().getBuildings());
    }
    ...
    void testRentRødovrevej() {
        ...
        FieldProperty fieldPropertyAction = (FieldProperty)board.getField(1);
        gameActions.buyProperty(player1, fieldPropertyAction.getProperty());
        gameActions.payRent(player2,fieldPropertyAction.getProperty());
        ...
        assertEquals(fieldPropertyAction.getOwner(),player1,"Spilleren: " + player1 + " skulle gerne være ejer. Ejeren er: " + fieldPropertyAction.getOwner());
    }
    ...
    void test2XRentRødovrevej() {
        ...
        FieldProperty fieldPropertyAction2 = (FieldProperty)board.getField(3);
        gameActions.buyProperty(player1, fieldPropertyAction.getProperty());
        gameActions.buyProperty(player1, fieldPropertyAction2.getProperty());
        gameActions.payRent(player2, fieldPropertyAction.getProperty());
    ...
    void testPledgingRødovrevej() {
        ...
        FieldProperty fieldPropertyAction = (FieldProperty)board.getField(1);
        gameActions.buyProperty(player, fieldPropertyAction.getProperty());
        gameActions.pledgeProperty(player, fieldPropertyAction.getProperty());


        //Ser om player har mistet rette penge og bygningen er pantsat
        assertEquals(player.getMoney(),moneyAfterBuying,"Spilleren burde have: " + moneyAfterBuying + ". Spilleren har: "+ player.getMoney());
        assertEquals(fieldPropertyAction.getProperty().getPledgestate(),true,"Rødovre skulle have være pledged så: " + true + " Rødovre pledgestate er: " + fieldPropertyAction.getProperty().getPledgestate());
    }
    ...
    void testRentPledgingRødovrevej() {
        ...
        FieldProperty fieldPropertyAction = (FieldProperty)board.getField(1);
        gameActions.buyProperty(player1, fieldPropertyAction.getProperty());
        gameActions.pledgeProperty(player1, fieldPropertyAction.getProperty());
        gameActions.payRent(player2, fieldPropertyAction.getProperty());
