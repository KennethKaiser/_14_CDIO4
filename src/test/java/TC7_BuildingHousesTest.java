...
class TC7_BuildingHousesTest {
    ...
    void testBuy3HousesHasCash() {
        ...
        Property property = new Property("DTU",PROPERTY_PRICE,HOUSE_PRICE,100,RENT_HOUSE,200,RENT_3HOUSE,800,900,5);
    ...
    void testBuy3HousesHasNoCash() {
        ...
        Property property = new Property("DTU",PROPERTY_PRICE,HOUSE_PRICE,100,RENT_HOUSE,RENT_2HOUSE,RENT_3HOUSE,800,900,5);
    ...
    void testBuy4HousesHasCash() {
        ...
        Property property = new Property("DTU",PROPERTY_PRICE,HOUSE_PRICE,100,RENT_HOUSE,200,700,RENT_4HOUSE,900,5);
    ...
    void testBuyHotelHasNoCash() {
        ...
        Property property = new Property("DTU",PROPERTY_PRICE,HOUSE_PRICE,100,200,200,700,RENT_4HOUSE,RENT_HOTEL,5);
